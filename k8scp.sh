...
sudo apt-get update
sudo apt-get -y install kubelet=1.31.1-1.1 kubeadm=1.31.1-1.1 kubectl=1.31.1-1.1
...
sudo kubeadm init --kubernetes-version=1.31.1 --pod-network-cidr=10.0.0.0/8  | sudo tee /var/log/kubeinit.log
